...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("SFA MVP Automation Report"); // Tile of report - given by the user
		htmlReporter.config().setReportName("Functional Automation Testing"); // name of the report - given by the user
	...
	//	htmlReporter.config().setTheme(Theme.STANDARD); 
		...
		extent.setSystemInfo("user","MTN-NG");
